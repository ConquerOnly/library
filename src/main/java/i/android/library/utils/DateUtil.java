...
public final class DateUtil {
    ...
    private DateUtil() {
        throw new Error("no need to instantiate!");
    }

/**
 * get daily date
 * @return format is {@link #yyyyMMDD  (yyyy-MM-dd)}
 */
     ...
     */
    public static String today(String pattern){return formatDate(getCurrentTimeInLong(),pattern);}
   ...
   * @return  Date to String*/
    ...
    public static Date parseDate(long dateL, String type) {
       return parseDate(formatDate(dateL,type),type);
    }
     ...
     */
    public static String translateDate(Long time,String pattern) {
    ...
    /**
     * translate time in default format {@link #yyyyMMDD}
     */
    public static String translateDate(Long time) {
      return   translateDate(time,yyyyMMDD);
    }
    /**
     * 转换日期 转换为更为人性化的时间
     *
