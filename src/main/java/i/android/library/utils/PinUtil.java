...
public class PinUtil {
    ...
    private static PinUtil sInstance;
    ...
    protected PinUtil(boolean hasChinaCollator) {
        mHasChinaCollator = hasChinaCollator;
    }

    public static PinUtil getInstance() {
